...
#	print(dim(x0))
	...
	x1[,2:dim(x1)[2]] = x1[,2:dim(x1)[2]][,order(colnames(x1[,2:dim(x1)[2]]))]
	x2[,2:dim(x2)[2]] = x2[,2:dim(x2)[2]][,order(colnames(x2[,2:dim(x2)[2]]))]
#	print(dim(x1))
#       print(dim(x2))

	colnames(x1)[2:dim(x1)[2]] = colnames(x1)[2:dim(x1)[2]][order(colnames(x1[,2:dim(x1)[2]]))]
	colnames(x2)[2:dim(x2)[2]] = colnames(x2)[2:dim(x2)[2]][order(colnames(x2[,2:dim(x2)[2]]))]
#	print(dim(x1))
#	print(dim(x2))

	x1=cbind(x1,x0[dim(x1)[1],-(1:(p+1))])
	x2=cbind(x2,x0[dim(x2)[1],-(1:(p+1))])
